...
export default function FacialesTreatmentPage() {
  const { treatment } = useParams();
  const treatmentData = treatmentPages.faciales[treatment];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F2F0F1] text-[#363633] font-sans selection:bg-[#CCC9C1] selection:text-[#141313]">
      <Helmet>
        ...
        <link rel="canonical" href={`https://dermamskinhealth.com/faciales/${treatment}`} />
