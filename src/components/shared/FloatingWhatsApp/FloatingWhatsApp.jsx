...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className={styles.container} id="derma-m-floating-whatsapp">
        ...
        <div className={styles.helperBubble}>
          ...
          <div className={styles.helperInner}>
            <div className={styles.helperTextContainer}>
              <p className={styles.helperTitle}>¿LISTA PARA CUIDAR TU PIEL?</p>
      ...
      >
        <span className={styles.labelBubble}>AGENDA POR WHATSAPP</span>
        <div className={styles.iconCircle}>
          {/* Custom brand-colored, high-fidelity recognizable WhatsApp logo */}
          <svg 
            viewBox="0 0 24 24" 
            width="24" 
            height="24" 
