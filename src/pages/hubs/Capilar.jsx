...
export default function CapilarPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#F2F0F1] text-[#363633] font-sans selection:bg-[#CCC9C1] selection:text-[#141313]">
      <Helmet>
        <title>Tratamientos Capilares en West Palm Beach | Derma.M</title>
        <meta name="description" content="Tratamientos para acompañar la salud y apariencia del cabello en Derma.M. West Palm Beach, Florida." />
        <link rel="canonical" href="https://dermamskinhealth.com/capilar" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Tratamientos Capilares en West Palm Beach | Derma.M" />
        <meta property="og:description" content="Tratamientos para acompañar la salud y apariencia del cabello en Derma.M. West Palm Beach, Florida." />
        ...
        <meta name="twitter:title" content="Tratamientos Capilares en West Palm Beach | Derma.M" />
        <meta name="twitter:description" content="Tratamientos para acompañar la salud y apariencia del cabello en Derma.M. West Palm Beach, Florida." />
