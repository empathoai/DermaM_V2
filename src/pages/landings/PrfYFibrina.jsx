...
export default function PrfYFibrinaPage() {
  return (
    <div className="flex flex-col min-h-screen">
      <Helmet>
        <title>PRP y Fibrina en West Palm Beach | Derma.M</title>
        ...
        <meta property="og:title" content="PRP y Fibrina en West Palm Beach | Derma.M" />
        ...
        <meta name="twitter:title" content="PRP y Fibrina en West Palm Beach | Derma.M" />
