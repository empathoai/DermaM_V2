  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F2F0F1] text-[#363633] font-sans selection:bg-[#CCC9C1] selection:text-[#141313]">
      <Helmet>
        ...
        <meta name="description" content="Conoce a Nancy Nieto, fundadora y directora de DERMA.M: su formación, filosofía de cuidado y la visión detrás de la clínica en West Palm Beach." />
        ...
        <meta property="og:description" content="Conoce a Nancy Nieto, fundadora y directora de DERMA.M: su formación, filosofía de cuidado y la visión detrás de la clínica en West Palm Beach." />
        ...
        <meta name="twitter:description" content="Conoce a Nancy Nieto, fundadora y directora de DERMA.M: su formación, filosofía de cuidado y la visión detrás de la clínica en West Palm Beach." />
