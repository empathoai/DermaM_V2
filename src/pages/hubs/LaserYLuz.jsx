...
export default function LaserYLuzPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#F2F0F1] text-[#363633] font-sans selection:bg-[#CCC9C1] selection:text-[#141313]">
      <Helmet>
        <title>Tratamientos Láser y Luz en West Palm Beach | Derma.M</title>
        <meta name="description" content="Tratamientos con tecnología estética para renovar y mejorar la piel en Derma.M. West Palm Beach, Florida." />
        <link rel="canonical" href="https://dermamskinhealth.com/laser-y-luz" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Tratamientos Láser y Luz en West Palm Beach | Derma.M" />
        <meta property="og:description" content="Tratamientos con tecnología estética para renovar y mejorar la piel en Derma.M. West Palm Beach, Florida." />
        ...
        <meta name="twitter:title" content="Tratamientos Láser y Luz en West Palm Beach | Derma.M" />
        <meta name="twitter:description" content="Tratamientos con tecnología estética para renovar y mejorar la piel en Derma.M. West Palm Beach, Florida." />
