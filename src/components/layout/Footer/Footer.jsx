        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brandCol}>
            ...
            <div className={styles.socialBlock}>
              <a
                href="https://www.instagram.com/dermamskinhealth"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="DERMA.M en Instagram"
                className={styles.socialLink}
              >
                <Instagram size={24} strokeWidth={1.5} aria-hidden="true" />
              </a>
              <a
                href="https://www.tiktok.com/@derma.m"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="DERMA.M en TikTok"
                className={styles.socialLink}
              >
              ...
              <a
                href="https://www.facebook.com/DermaMskinhealth"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="DERMA.M en Facebook"
                className={styles.socialLink}
              >
          ...
          <div className={styles.navCol}>
            ...
            <address className={styles.addressBlock}>
              ...
              <p className={styles.contactItem}>
                <a href={whatsappUrl} onClick={trackWhatsAppClick} className={styles.link} target="_blank" rel="noopener noreferrer">WhatsApp</a>
              </p>
